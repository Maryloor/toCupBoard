...
(function($) {
    ...
    coffee_bistro_section_lists.forEach(coffee_bistro_homepage_scroll_preview);

    function coffee_bistro_homepage_scroll_preview(item, index) {
        ...
        wp.customize.bind('preview-ready', function() {
            ...
            wp.customize.preview.bind(item, function(data) {
                ...
                if (true === data.expanded) {
                    $('html, body').animate({
                        'scrollTop': $('#coffee_bistro_' + item + '_section').position().top
                    });
                }
            });
...
(function($) {
    wp.customize('coffee_bistro_enable_breadcrumb', function(value) {
...
(function($) {
    wp.customize('coffee_bistro_website_layout', function(value) {
        value.bind(function(newval) {
            if (newval) {
...
(function($) {
    wp.customize('coffee_bistro_layout_width_margin', function(value) {
        value.bind(function(newval) {
...
( function( $ ) {
    wp.customize( 'coffee_bistro_sidebar_width', function( value ) {
        value.bind( function( newval ) {
